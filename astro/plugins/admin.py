...
from astro.utils import admin_cmd, errors_handler, sudo_cmd
...
@astro.on(admin_cmd(outgoing=True, pattern="setgpic"))
@astro.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@astro.on(admin_cmd("promote(?: |$)(.*)"))
@astro.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@astro.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@astro.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@astro.on(admin_cmd(pattern="(ban|unban) ?(.*)"))
@astro.on(sudo_cmd(pattern="(ban|unban) ?(.*)", allow_sudo=True))
async def _(event):
...
@astro.on(admin_cmd(pattern="pgs ?(.*)"))
@astro.on(sudo_cmd(pattern="pgs ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@astro.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@astro.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@astro.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@astro.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@astro.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@astro.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
