...
UPSTREAM_REPO_URL = "https://github.com/AstroUB/AstroUB"
...
async def upstream(ups):
    ...
    try:
        ...
        origin.fetch()
        force_updateme = True
        repo.create_head('main', origin.refs.Astro)
    ...
    if force_updateme:
        ...
        await ups.edit('Updated✨\nRestarting it please have patience\nUntil a New Deploy Message Comes Into Your Private Group')
    ...
    if Config.HEROKU_API_KEY is not None:
        ...
        await ups.edit('`Sync Verified Successfully 🙂🙂\n'
                       'Restarting, please wait a min ,then type .alive to check if I alive !! Else Come to [Astro_HelpChat](https://t.me/Astro_HelpChat')
    else:
