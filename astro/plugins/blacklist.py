...
import astro.plugins.sql.blacklist_sql as sql
...
@astro.on(admin_cmd(pattern="addblacklist ((.|\n)*)"))
@astro.on(sudo_cmd(pattern="addblacklist ((.|\n)*)"))
...
@astro.on(admin_cmd(pattern="listblacklist"))
@astro.on(sudo_cmd(pattern="listblacklist"))
...
@astro.on(admin_cmd(pattern="rmblacklist ((.|\n)*)"))
@astro.on(sudo_cmd(pattern="rmblacklist ((.|\n)*)"))
