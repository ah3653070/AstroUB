...
@astro.on(admin_cmd(outgoing=True, pattern=r"mute ?(\d+)?"))
@astro.on(sudo_cmd(allow_sudo=True, pattern=r"mute ?(\d+)?"))
...
@astro.on(admin_cmd(outgoing=True, pattern=r"unmute ?(\d+)?"))
@astro.on(sudo_cmd(allow_sudo=True, pattern=r"unmute ?(\d+)?"))
